  ...
  return (
    <Main>
      ...
      <p>
        ...
        <br />
        자가용 이용시
          분당방면 : 한남대교→장충단길→신라호텔 후문→서울신라호텔/신라면세점
          강남방면 : 동호대교→장충체육관 앞 사거리에서 비보호 좌회전→서울신라호텔/신라면세점
          용산방면 : 남산2호터널 통과 후 좌회전→신라호텔 후문→서울신라호텔/신라면세점
        
        버스 이용시
          장충체육관 앞 하차 (※ 노선번호:144,301,7212)
          서울신라호텔 정문(기와문)에서 호텔 로비와 면세점까지 무료 관내 셔틀 운행
          운행코스 : 서울신라호텔 로비 → 신라면세점 → 호텔 고객 주차장 → 서울신라호텔 정문
          운행시간 : 08:00 ~ 22:00 (수시 운행)
          ※ 교통상황에 따라 셔틀 운행 시간이 변동될 수 있습니다.
          ※ 고객 안전을 위하여 정원 초과 시 탑승이 제한될 수 있습니다.
