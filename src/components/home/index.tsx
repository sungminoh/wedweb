    ...
    <Main>
      ...
      <p>
        ...
        ● 자가용 이용시 <br />
          ...
          용산방면 : 남산2호터널 통과 후 좌회전→신라호텔 후문→서울신라호텔/신라면세점 <br />
        <br />
        ● 버스 이용시 <br />
          장충체육관 앞 하차 (※ 노선번호:144,301,7212) <br />
          서울신라호텔 정문(기와문)에서 호텔 로비와 면세점까지 무료 관내 셔틀 운행 <br />
          운행코스 : 서울신라호텔 로비 → 신라면세점 → 호텔 고객 주차장 → 서울신라호텔 정문 <br />
          운행시간 : 08:00 ~ 22:00 (수시 운행) <br />
          ※ 교통상황에 따라 셔틀 운행 시간이 변동될 수 있습니다. <br />
          ※ 고객 안전을 위하여 정원 초과 시 탑승이 제한될 수 있습니다. <br />
          <br />
        ● 지하철 이용시 <br />
