  ...
  return (
    <Main>
      ...
      <GiveWrap>
        ...
        <pre>  분당방면:한남대교→장충단길→신라호텔 후문→서울신라호텔/신라면세점 </pre><br/>
        <pre>  강남방면:동호대교→장충체육관 앞 사거리에서 비보호 좌회전→서울신라호텔/신라면세점 </pre><br/>
        <pre>  용산방면:남산2호터널 통과 후 좌회전→신라호텔 후문→서울신라호텔/신라면세점 </pre><br/>
      </GiveWrap>
